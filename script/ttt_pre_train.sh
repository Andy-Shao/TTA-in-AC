...
# python ttt/pre_time_shift_train.py --dataset_root_path '/root/data/AudioMNIST/data' --max_epoch 10 --depth 26 --shift_limit 0.2625 \
...
python ttt/pre_angle_shift_train.py --dataset_root_path '/root/data/AudioMNIST/data' --max_epoch 10 --depth 26 \

...
python -m ttt.speech_commands.time_shift_analysis \
    --origin_model_weight_file_path './result/speech-commands/ttt/pre_time_shift_train/ts_bn_ckpt.pth' \
    --dataset 'speech-commands' --output_csv_name 'background_1.0-accuracy_record.csv' \
    --dataset_root_path $BASE_PATH'/data/speech_commands' --depth 50 --severity_level 1.0 --batch_size 126 \

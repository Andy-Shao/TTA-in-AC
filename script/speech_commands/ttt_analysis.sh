...
#     --dataset_root_path $BASE_PATH'/data/speech_commands' --depth 26 --severity_level 3.0 --batch_size 32 \
#     --corruptions 'exercise_bike' \
#     --TTT_analysis --lr 1e-3 --threshold 0.99 --shift_limit 0.2625 --mode 'offline' --niter 20
...
python -m ttt.speech_commands.time_shift_analysis \
    ...
    --dataset_root_path $BASE_PATH'/data/speech_commands' --depth 26 --severity_level 10.0 --batch_size 32 \
    --corruptions 'exercise_bike' \
    --TTT_analysis --lr 1e-3 --threshold 0.99 --shift_limit 0.2625 --mode 'offline' --niter 20

...
python -m ttt.bg_time_shift_analysis --origin_model_weight_file_path './result/audio-mnist/ttt/pre_time_shift_train/ts_bn_ckpt.pth' \
     --dataset_root_path $BASE_PATH'/data/AudioMNIST/data' --depth 26 --threshold 0.99 --shift_limit 0.2625 --severity_level 3.0 \
     --batch_size 126 --output_csv_name 'ts_bn_accuracy_record_bg-rand-3.0.csv' --background_root_path $BASE_PATH'/data/speech_commands' \

...
python CoNMix/analysis.py --dataset 'audio-mnist' --dataset_root_path '/root/data/AudioMNIST/data' \
    --temporary_path '/root/tmp/AudioMNIST_analysis_005_weak' --batch_size 256 --cal_norm 'corrupted' \
...
#     --output_csv_name 'accuracy_record_005.csv' --corrupted_mean '-25.915005, -25.915005, -25.915005' \
#     --corrupted_std '6.7119627, 6.7119627, 6.7119627'
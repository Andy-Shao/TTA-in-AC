...
#     --temporary_path '/root/tmp/AudioMNIST_analysis_005_weak' --batch_size 256 --cal_norm \
#     --severity_level 0.005
...
#     --output_csv_name 'accuracy_record_005.csv' --corrupted_mean '-25.916967, -25.916967, -25.916967' \
#     --corrupted_std '6.721381, 6.721381, 6.721381' \

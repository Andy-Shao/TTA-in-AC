...
#     --alpha 0.9 --initc_num 1 --dataset 'speech-commands' --cls_mode 'logsoft_ce' --lr_gamma 30 --wandb \
...
#     --alpha 0.9 --initc_num 1 --dataset 'speech-commands' --cls_mode 'logsoft_ce' --lr_gamma 30 \
...
#     --alpha 0.9 --initc_num 1 --dataset 'speech-commands' --cls_mode 'logsoft_ce' --lr_gamma 30 --wandb \
#     --wandb_name 'DD-10dB-org' --backup_weight 1
...
#     --data_type 'final' --const_par 0.2 --fbnm_par 4.0 --cls_par 0.2 --corruption 'exercise_bike' \
#     --alpha 0.9 --initc_num 1 --dataset 'speech-commands' --cls_mode 'logsoft_ce' --lr_gamma 30 --wandb \
#     --wandb_name 'EB-10dB-org' --backup_weight 1

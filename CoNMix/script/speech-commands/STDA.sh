...
#     --data_type 'final' --wandb --const_par 0.2 --fbnm_par 4.0 --cls_par 2.0 --corruption 'running_tap' \
#     --alpha 0.9 --initc_num 1 
...
#     --data_type 'final' --wandb --const_par 0.2 --fbnm_par 6.0 --cls_par 1.0 --corruption 'running_tap' \
#     --alpha 0.9 --initc_num 1
...
python -m CoNMix.speech-commands.STDA \
    ...
    --data_type 'final' --const_par 0.2 --fbnm_par 6.0 --cls_par 1.0 --corruption 'running_tap' \
    --alpha 0.9 --initc_num 1 --dataset 'speech-commands-purity' --wandb
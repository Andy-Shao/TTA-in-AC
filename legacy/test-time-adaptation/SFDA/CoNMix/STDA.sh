...
python STDA.py --source 1 --target 0 2 3 --dataset office-home --net vit --max_epoch 50 --interval 50 --batch_size 32
python STDA.py --source 2 --target 1 0 3 --dataset office-home --net vit --max_epoch 50 --interval 50 --batch_size 32
python STDA.py --source 3 --target 1 2 0 --dataset office-home --net vit --max_epoch 50 --interval 50 --batch_size 32
